          ...
          <div className="flex animate-scroll">
            {infiniteTestimonials.map((testimonial, index) => (
              <motion.div
                ...
                className={`group relative p-6 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 transform flex-shrink-0 w-80 mx-4 ${
                  theme === 'dark'
              ...
              >
                ...
                {/* Quote */}
                <blockquote className={`text-base leading-relaxed italic mb-4 p-4 rounded-2xl border-l-4 ${
                  theme === 'dark'
...
export default Testimonials;
              ...
              {/* Quote */}
              <blockquote className={`text-base leading-relaxed italic mb-6 p-4 rounded-2xl border-l-4 ${
                theme === 'dark'
                  ? 'text-dark-gray-300 bg-dark-gray-800/50 border-dark-accent/50'
                  : 'text-gray-700 bg-gray-50 border-accent/50'
              }`}>
