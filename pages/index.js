        ...
        >
          ...
          <div className="text-center relative z-10 max-w-5xl mx-auto px-6">
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl font-sans text-white/90 mb-8 max-w-2xl mx-auto leading-normal"
            >
              Serving in Nellore, Tirupati, and Hyderabad with premium interior solutions
            </motion.p>
